...
const api = {
  ...
  mcp: {
    ...
    save: (config: McpConfigInput, options?: Omit<McpSaveRequest, "config">): Promise<{ ok: boolean; config?: McpConfigInput; issues?: Array<{ code: string; path: string; message: string }> }> => ipcRenderer.invoke("mcp:save", { config, ...options }),
